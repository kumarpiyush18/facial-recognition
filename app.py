...
def main(directory, faces_embeddings_path, model_path,outputdir):
    ...
    app = TestSample(directory=directory,faces_embeddings_path=faces_embeddings_path,model_path=model_path,outputdir=outputdir)
    app.run()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--faces_embeddings_path", default="./assets/face_embeddings_extract.npz", help="Path to face embeddings")
    ...
    main(directory=args.directory, faces_embeddings_path=args.faces_embeddings_path, model_path=args.model_path,outputdir=args.outputdir)
